			...
			if($processImage && resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
			{
				...
				if(!cropImage($CurWidth,$CurHeight,$ThumbSquareSize,$thumb_DestRandImageName,$CreatedImage,$Quality,$ImageType))
					...
					*/
					...
					echo '<ul class="top">';
						echo '<li><a href="delete.php?post='.$post_id.'">Delete</a></li><li><a href="editor.php?post='.$post_id.'&&item='.$title.'&&price='.$cost.'&&describe='.$comments.'&&image='.$thumb_DestRandImageName.'">Edit</a></li><li><a href="uploadformmulti.php?item='.$title.'&&post='.$post_id.'">Add More Pics</a></li>';
					echo'</ul>';
						...
						echo '<strong>Post Preview</strong>';
								...
								echo '<section>';
									...
									echo '<br />';
									echo '<br />';
									echo '<img src="'.$thumb_DestRandImageName.'"/>';
